...
export default function Footer() {
  return (
    <footer className="bg-black text-vbrown-cream mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-10 py-14 grid md:grid-cols-4 gap-10">
        <div>
        ...
        <div>
          <p className="text-xs tracking-[0.2em] uppercase text-vbrown-cream/35 mb-4">App</p>
          <p className="text-sm text-vbrown-cream/65 leading-relaxed">
            Tap <strong className="text-vbrown-cream">Get app</strong> in the header to save VV Brown on your phone or computer. No app store required.
          </p>
        </div>
        <div>
